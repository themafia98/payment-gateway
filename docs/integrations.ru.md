...
Три из них выписаны целиком в [`examples/providers`](../examples/providers/README.md) —
Stripe, Adyen и PayPal, по их настоящим формам API. В CI они проверяются на соответствие
контракту.
