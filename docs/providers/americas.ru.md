...
Редиректить некуда и собирать нечего: вы показываете код и ждёте. Действия для этого в
контракте пока нет — см. [заметку о пробеле](./asia.ru.md#пробел-qr-коды-и-диплинки), она
относится сюда один в один.

**OXXO и Boleto** — ваучеры. Покупатель получает квитанцию или штрихкод и платит наличными в
магазине, иногда через несколько дней. Тот же пробел плюс куда более долгое ожидание:
моделируйте платёж как `processing`, а результат сообщайте письмом, а не заставляйте человека
сидеть на странице.
