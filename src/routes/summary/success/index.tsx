      ...
      <main className="min-h-[100svh] bg-gradient-to-br from-[#06040a] via-[#10091c] to-[#2a0f46]">
        <div className="p-8 text-center space-y-6 min-h-[100svh] gap-6">
          ...
          <section className="space-y-4">
            <button
                data-name="Button"
                className="flex w-full h-10 cursor-pointer items-center justify-center rounded-[14px] px-[27.765213012695312px] py-0 text-white bg-purple-500"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                   stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                   className="lucide lucide-download w-4 h-4 mr-2" aria-hidden="true">
            ...
            <button
                onClick={() => navigate({ to: "/" })}
                data-name="Button"
                className="flex w-full h-10 cursor-pointer items-center justify-center rounded-[14px] px-[27.765213012695312px] py-0 text-white bg-purple-500/50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                   stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                   className="lucide lucide-arrow-left w-4 h-4 mr-2" aria-hidden="true">
